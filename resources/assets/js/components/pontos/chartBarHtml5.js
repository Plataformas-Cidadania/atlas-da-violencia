            ...
            let bars = this.state.values.map(function(item, index){
                ...
                return (
                    <li key={'itemChartBar'+this.state.chart+"_"+index} style={{height:(item.value*100/max)+'%'}}>
                        <span style={{height:(item.value*100/max)+'%', maxWidth: '30px'}} className='bg-pri'><strong className="hidden-xs">{value} {parenteseAberto}{percent}{parenteseFechado}</strong></span>
