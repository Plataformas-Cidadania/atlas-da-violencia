class TypeAccident extends React.Component{
    ...
    render(){
        ...
        return(
            <div>
                <input type="text" name="titleType" className="form-control input-sm" onClick={this.clickSearch} onChange={this.handleSearch} placeholder="Pesquise pelo tipo de acidente"/>
