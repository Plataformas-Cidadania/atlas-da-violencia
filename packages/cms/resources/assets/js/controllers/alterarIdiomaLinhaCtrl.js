cmsApp.controller('alterarIdiomaLinhaCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.alterar = function (file){
        ...
        if(file==null){
            ...
            $http.post("cms/alterar-idioma-linha/"+$scope.id, {'linha': $scope.linha, 'removerImagem': $scope.removerImagem}).success(function (data){
                //console.log(data);
                $scope.processandoSalvar = false;
            ...
            file.upload = Upload.upload({
                url: 'cms/alterar-idioma-linha/'+$scope.id,
                data: {linha: $scope.linha, file: file},
            });
            ...
            file.upload.then(function (response) {
                ...
                $scope.removerImagem = false;
                $scope.imagemBD = 'imagens/idiomas_linhas/'+response.data;
