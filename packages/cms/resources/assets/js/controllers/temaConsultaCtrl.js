cmsApp.controller('temaConsultaCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.dadoPesquisa = '';
    $scope.campos = "temas_consultas.id, idiomas_temas.titulo";
    ...
    var listarConsultas = function(){
        ...
        $http({
            url: 'cms/listar-temas-consultas',
            method: 'GET',
            params: {
    ...
    $scope.inserir = function (file){
        ...
        if(file==null){
            ...
            $http.post("cms/inserir-tema-consulta", {tema: $scope.tema}).success(function (data){
                 listarConsultas();
            ...
            file.upload.then(function (response) {
                ...
                //delete $scope.tema;//limpa o form
                delete $scope.temas.titulo;
                delete $scope.temas.descricao;
    ...
    $scope.excluir = function(id){
        ...
        $http({
            url: 'cms/excluir-tema-consulta/'+id,
            method: 'GET'
        }).success(function(data, status, headers, config){
            console.log(data);
            $scope.processandoExcluir = false;
