cmsApp.controller('textoSerieCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.inserir = function (file){
        ...
        if(file==null){
            ...
            $http.post("cms/inserir-texto-serie", {serie: $scope.serie, textos: $scope.textos}).success(function (data){
                 listarSeries();
                 //delete $scope.serie;//limpa o form
                delete $scope.serie.titulo;
                delete $scope.serie.descricao;
    ...
    $scope.excluir = function(id){
        ...
        $http({
            url: 'cms/excluir-texto-serie/'+id,
            method: 'GET'
        }).success(function(data, status, headers, config){
            console.log(data);
            $scope.processandoExcluir = false;
