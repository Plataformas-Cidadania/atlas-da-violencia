cmsApp.controller('alterarTemaCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.alterar = function (file){
        ...
        if(file==null){
            ...
            $http.post("cms/alterar-tema/"+$scope.id, {'tema': $scope.tema, 'removerImagem': $scope.removerImagem}).success(function (data){
                //console.log(data);
                $scope.processandoSalvar = false;
            ...
            file.upload.then(function (response) {
                ...
                $scope.removerImagem = false;
                $scope.imagemBD = '/imagens/temas/'+response.data;
