cmsApp.controller('linkCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    /*$scope.loadMore = function() {
     $scope.currentPage +=1;
     $http({
     url: '/api/links/'+$scope.itensPerPage,
     method: 'GET',
     ...
     //$scope.links = $scope.links.concat(data.data);
