...
@section('content')
    {!! Html::script('assets-cms/js/controllers/versaoCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="versaoCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-versao" aria-hidden="true"></i>&nbsp;Versões</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Nova versão</button>
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="versaor:pointer;">
                                Id
                            ...
                            <th>Imagem</th>
                            <th ng-click="ordernarPor('versao')" style="versaor:pointer;">
                                Versao
                                <i ng-if="ordem=='versao' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='versao' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th ng-click="ordernarPor('posicao')" style="versaor:pointer;">
                                Posição
                            ...
                            <th ng-click="ordernarPor('idioma_sigla')" style="noticiar:pointer;">
                                Idioma
                        ...
                        <tbody>
                        <tr ng-repeat="versao in versoes">
                            <td><% versao.id %></td>
                            <td><img ng-show="versao.imagem" ng-src="imagens/versoes/xs-<% versao.imagem %>" width="60"></td>
                            <td><a href="cms/versao/<% versao.id %>"><% versao.titulo %></a></td>
                            <td><a href="cms/versao/<% versao.id %>"><% versao.posicao %></a></td>
                            <td><a href="cms/versao/<% versao.id %>"><% versao.idioma_sigla %></a></td>
                            <td class="text-right">
                                <div>

                                    <a><i class="fa fa-arrow-circle-up fa-2x" title="Posição" ng-click="positionUp(versao.id);" style="cursor: pointer;" ng-hide="<% $first %>"></i></a>
                                    <a><i class="fa fa-minus-circle fa-2x" title="Posição"   ng-show="<% $first %>" style="color: #CCCCCC; margin-right: 5px;"></i></a>&nbsp;&nbsp;

                                    <a><i class="fa fa-arrow-circle-down fa-2x" title="Posição" ng-click="positionDown(versao.id);"  style="cursor: pointer;" ng-hide="<% $last %>"></i></a>
                                    <a><i class="fa fa-minus-circle fa-2x" title="Posição"   ng-show="<% $last %>" style="color: #CCCCCC; margin-right: 5px;"></i></a>&nbsp;&nbsp;

                                    <a href="cms/items-versao/<% versao.id %>"><i class="fa fa-sitemap fa-2x" title="Itens"></i></a>&nbsp;&nbsp;
                                    <a href="cms/versao/<% versao.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
                                    <a  ng-class="<% versao.status %> == 1 ? 'color-success' : 'color-success-inactive'"  style="cursor: pointer;"><i class="fa fa-check-circle fa-2x" aria-hidden="true" ng-click="status(versao.id);"></i></a>
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(versao.id, versao.titulo, versao.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/versoes/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
