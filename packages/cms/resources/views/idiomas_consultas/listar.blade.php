...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/idiomaConsultaCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="idiomaConsultaCtrl" ng-init="setConsultaId({{$consulta_id}})">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-newspaper-o"></i>&nbsp;Idiomas Consultas</h1>
            ...
            <div ng-show="mostrarForm">
                ...
                @include('cms::idiomas_consultas._form')
                <div class="row">
                ...
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th ng-click="ordernarPor('consulta')" style="consultar:pointer;">
                                Titulo
                        ...
                        <tr ng-repeat="consulta in consultas">
                            <td><% consulta.id %></td>
                            <td style="display:none;"><img ng-show="consulta.imagem" ng-src="imagens/idiomas_consultas/xs-<% consulta.imagem %>" width="60"></td>
                            <td><a href="cms/idioma-consulta/<% consulta.id %>"><% consulta.titulo %></a></td>
			    <td><% consulta.idioma_sigla %></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/idioma-consulta/<% consulta.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/idiomas_consultas/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
