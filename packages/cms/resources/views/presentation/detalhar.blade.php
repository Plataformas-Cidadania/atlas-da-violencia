...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarPresentationCtrl.js') !!}
    <div ng-controller="alterarPresentationCtrl">
        <div class="box-padrao">
            <h1><a href="cms/presentations"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Apresentação</h1>
            <?php //print_r($presentation);?>
            <div ng-init="carregaImagem('{{$presentation->imagem}}', '{{$presentation->arquivo}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($presentation, ['name' =>'form']) !!}
                ...
                <a href="arquivos/presentations/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                <a ng-show="fileArquivo"><% fileArquivo.name %></a>
                <br><br>
                @include('cms::presentation._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$presentation->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile, fileArquivo)" ng-disabled="form.$invalid && form.presentation.$dirty">Salvar</button>
                    </div>
