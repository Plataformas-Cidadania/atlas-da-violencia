...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/presentationCtrl.js') !!}
<script>
    $(function () {
    ...
    <div ng-controller="presentationCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-newspaper-o"></i>&nbsp;Apresentações</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Nova Apresentação</button>
            ...
            <div ng-show="mostrarForm">
                ...
                <br><br>
                @include('cms::presentation._form')
                <div class="row">
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="presentationr:pointer;">
                                Id
                            ...
                            <th ng-click="ordernarPor('slug')" style="presentationr:pointer;">
                                Slug
                                <i ng-if="ordem=='slug' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='slug' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th></th>
                        </tr>
                        </thead>
                        ...
                        <tr ng-repeat="presentation in presentations">
                            ...
                            <td><a href="cms/presentation/<% presentation.id %>"><% presentation.slug %></a></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/presentation-elements/<% presentation.id %>"><i class="fa fa-object-group fa-2x" title="Elementos"></i></a>&nbsp;&nbsp;
                                    <a href="cms/presentation/<% presentation.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(presentation.id, presentation.titulo, presentation.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/presentations/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
