...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarApiCtrl.js') !!}
    <div ng-controller="alterarApiCtrl">
        <div class="box-padrao">
            <h1><a href="cms/apis"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Apis</h1>
            <?php //print_r($api);?>
            <div ng-init="carregaImagem('{{$api->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($api, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$api->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.api.$dirty">Salvar</button>
                    </div>
