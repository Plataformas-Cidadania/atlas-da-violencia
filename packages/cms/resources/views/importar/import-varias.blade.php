...
@section('content')
    {!! Html::script('assets-cms/js/controllers/importarCtrl.js') !!}
    <div ng-controller="importarCtrl">
        <div class="box-padrao">
            <h1><a href="cms/importars"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Importar Várias Séries</h1>
            ...
            <div >
                ...
                <div ng-if="tipo_dados==='0'">
                    ...
                    <div id="modelo1">
                        <div><strong>Exemplo: importars.csv</strong></div>
                    ...
                    <div><strong>Integrações  ******Pegar do banco id, nome*****</strong></div>
                    <div style="padding: 10px; background-color: #ccc; color:#333; width:400px;">
                        <div>1 - Ônibus</div>
                        <div>2 - Aeroporto</div>
                        <div>3 - Metro</div>
