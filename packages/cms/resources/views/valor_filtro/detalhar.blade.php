...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarValorFiltroCtrl.js') !!}
    <div ng-controller="alterarValorFiltroCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Valores versão</h1>
            <?php //print_r($valor);?>
            <div ng-init="carregaImagem('{{$valor->imagem}}', '{{$valor->arquivo}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($valor, ['name' =>'form']) !!}
                ...
                <a href="arquivos/valores-filtro/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                <a ng-show="fileArquivo"><% fileArquivo.name %></a>
                <br><br>

                <br><br>
                @include('cms::valor_filtro._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$valor->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile, fileArquivo)" ng-disabled="form.$invalid && form.valor.$dirty">Salvar</button>
                    </div>
