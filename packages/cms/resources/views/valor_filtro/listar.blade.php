...
@section('content')
    {!! Html::script('assets-cms/js/controllers/valorFiltroCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="valorFiltroCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;Valores Filtro</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Novo Valor</button>
            ...
            <div style="display: none;">
                ...
                @include('cms::valor_filtro._form')
                <div class="row">
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="valorr:pointer;">
                                Id
                        ...
                        <tr ng-repeat="valor in valores">
                            <td><% valor.id %></td>
                            <td><img ng-show="valor.imagem" ng-src="imagens/integrantes/xs-<% valor.imagem %>" width="60"></td>
                            <td>{{--<a href="cms/valor-filtro/<% valor.id %>">--}}<% valor.titulo %>{{--</a>--}}</td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/valor-filtro/<% valor.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
                                    {{--<a  ng-class="<% valor.status %> == 1 ? 'color-success' : 'color-success-inactive'"  style="cursor: pointer;"><i class="fa fa-check-circle fa-2x" aria-hidden="true" ng-click="status(valor.id);"></i></a>--}}
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(valor.id, valor.titulo, valor.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div ng-show="totalItens > 0" class="clan-paginacao">
                    <div class="valor-paginacao">
                        <uib-pagination total-valores="totalItens" ng-model="currentPage" max-size="maxSize" class="pagination-sm" boundary-links="true" force-ellipses="true" valores-per-page="itensPerPage" num-pages="numPages"></uib-pagination>
                    </div>
                    <div class="valor-paginacao">
                        <select class="form-control itens-por-pagina valor-paginacao"  ng-model="itensPerPage">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/valores/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
