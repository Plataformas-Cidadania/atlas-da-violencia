...
{!! Form::select('idioma_sigla',
        $idiomas,
null, ['class'=>"form-control width-medio <% validar(noticia.idioma_sigla) %>", 'ng-model'=>'noticia.idioma_sigla', 'ng-required'=>'true', 'init-model'=>'noticia.idioma_sigla', 'placeholder' => 'Selecione']) !!}<br>
