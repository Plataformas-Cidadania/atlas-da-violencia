...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/noticiaCtrl.js') !!}
<script>
    $(function () {
    ...
    <div ng-controller="noticiaCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-newspaper-o"></i>&nbsp;Noticias</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Nova Noticia</button>
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="noticiar:pointer;">
                                Id
                            ...
                            <th>Imagem</th>
                            <th ng-click="ordernarPor('noticia')" style="noticiar:pointer;">
                                Noticia
                                <i ng-if="ordem=='noticia' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='noticia' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                        ...
                        <tr ng-repeat="noticia in noticias">
                            ...
                            <td><a href="cms/noticia/<% noticia.id %>"><% noticia.idioma_sigla %></a></td>
                            <td class="text-right">
                                <div>
