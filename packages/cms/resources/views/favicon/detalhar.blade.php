...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarFaviconCtrl.js') !!}
    <div ng-controller="alterarFaviconCtrl">
        <div class="box-padrao">
            <h1><a href="../favicons"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Favicons</h1>
            <?php //print_r($favicon);?>
            <div ng-init="carregaImagem('{{$favicon->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($favicon, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$favicon->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.favicon.$dirty">Salvar</button>
                    </div>
