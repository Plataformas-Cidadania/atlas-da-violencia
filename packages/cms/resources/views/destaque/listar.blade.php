...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/destaqueCtrl.js') !!}
<script>
    $(function () {
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tbody>
                        <tr ng-repeat="destaque in destaques">
                            <td><% destaque.id %></td>
                            <td><img ng-show="destaque.imagem" ng-src="/imagens/destaques/xs-<% destaque.imagem %>" width="60"></td>
                            <td><a href="cms/destaque/<% destaque.id %>"><% destaque.titulo %></a></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/destaque/<% destaque.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(destaque.id, destaque.titulo, destaque.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="/imagens/destaques/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
