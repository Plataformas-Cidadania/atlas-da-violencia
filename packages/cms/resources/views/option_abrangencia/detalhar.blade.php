...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarOptionAbrangenciaCtrl.js') !!}
    <div ng-controller="alterarOptionAbrangenciaCtrl">
        <div class="box-padrao">
            <h1><a href="cms/options-abrangencias"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Option Abrangencia</h1>
            <?php //print_r($optionAbrangencia);?>
            <div ng-init="carregaImagem('{{$optionAbrangencia->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($optionAbrangencia, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$optionAbrangencia->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.optionAbrangencia.$dirty">Salvar</button>
                    </div>
