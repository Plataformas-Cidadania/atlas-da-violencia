...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarAssuntoCtrl.js') !!}
    <div ng-controller="alterarAssuntoCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Assuntos</h1>
            <?php //print_r($assunto);?>
            <div ng-init="carregaImagem('{{$assunto->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($assunto, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$assunto->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.assunto.$dirty">Salvar</button>
                    </div>
