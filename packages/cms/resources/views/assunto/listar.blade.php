...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/assuntoCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="assuntoCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-folder-open"></i>&nbsp;Assuntos</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Novo Assunto</button>
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="assuntor:pointer;">
                                Id
                            ...
                            {{--<th>Imagem</th>--}}
                            <th ng-click="ordernarPor('idiomas_assuntos.titulo')" style="assuntor:pointer;">
                                Assunto
                                <i ng-if="ordem=='idiomas_assuntos.titulo' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='idiomas_assuntos.titulo' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th ng-click="ordernarPor('idiomas_assuntos.idioma_sigla')" style="assuntor:pointer;">
                                Idioma
                                <i ng-if="ordem=='idiomas_assuntos.idioma_sigla' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='idiomas_assuntos.idioma_sigla' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            {{--<th ng-click="ordernarPor('position')" style="assuntor:pointer;">
                                Posição
                        ...
                        <tr ng-repeat="assunto in assuntos">
                            <td><% assunto.id %></td>
                            {{--<td><img ng-show="assunto.imagem" ng-src="imagens/assuntos/xs-<% assunto.imagem %>"  width="60"></td>--}}
                            <td><a href="cms/idiomas-assuntos/<% assunto.id %>"><% assunto.titulo %></a></td>
                            <td><a href="cms/idiomas-assuntos/<% assunto.id %>"><% assunto.idioma_sigla %></a></td>
                            {{--<td><a href="cms/idiomas-assuntos/<% assunto.id %>"><% assunto.position %></a></td>--}}
                            <td class="text-right">
                                <div>
                                    {{--<a><i class="fa fa-arrow-circle-up fa-2x" title="Posição" ng-click="positionUp(assunto.id);" style="cursor: pointer;" ng-hide="<% $first %>"></i></a>
                                    <a><i class="fa fa-minus-circle fa-2x" title="Posição"   ng-show="<% $first %>" style="color: #CCCCCC; margin-right: 5px;"></i></a>&nbsp;&nbsp;

                                    <a><i class="fa fa-arrow-circle-down fa-2x" title="Posição" ng-click="positionDown(assunto.id);"  style="cursor: pointer;" ng-hide="<% $last %>"></i></a>
                                    <a><i class="fa fa-minus-circle fa-2x" title="Posição"   ng-show="<% $last %>" style="color: #CCCCCC; margin-right: 5px;"></i></a>--}}
                                    <a ng-class="<% assunto.status %> == 1 ? 'color-success' : 'color-success-inactive'"  style="cursor: pointer;"><i class="fa fa-check-circle fa-2x" aria-hidden="true" ng-click="status(assunto.id);"></i></a>
                                    <a href="cms/idiomas-assuntos/<% assunto.id %>"><i class="fa fa-language fa-2x" title="Idiomas"></i></a>&nbsp;&nbsp;
                                    {{--<a href="cms/assunto/<% assunto.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;--}}
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(assunto.id, assunto.assunto, assunto.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/assuntos/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% assuntoExcluir %></p>
                            </div>
