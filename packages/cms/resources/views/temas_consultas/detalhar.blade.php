...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarTextoConsultaCtrl.js') !!}
    <div ng-controller="alterarTextoConsultaCtrl">
        <div class="box-padrao">
            <h1><a href="cms/textos_tema_consultas"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Tema Consulta</h1>
            <div ng-init="carregaImagem('{{$tema_consulta->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($tema_consulta, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$tema_consulta->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.tema_consulta.$dirty">Salvar</button>
                    </div>
