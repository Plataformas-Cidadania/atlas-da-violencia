...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/idiomaTransporteCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="idiomaTransporteCtrl" ng-init="setTransporteId({{$transporte_id}})">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-language"></i>&nbsp;Idiomas Transportes</h1>
            ...
            <div ng-show="mostrarForm">
                ...
                @include('cms::idiomas_transportes._form')
                <div class="row">
                ...
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tr ng-repeat="transporte in transportes">
                            <td><% transporte.id %></td>
                            <td style="display:none;"><img ng-show="transporte.imagem" ng-src="imagens/idiomas_transportes/xs-<% transporte.imagem %>" width="60"></td>
                            <td><a href="cms/idioma-transporte/<% transporte.id %>"><% transporte.titulo %></a></td>
			    <td><% transporte.idioma_sigla %></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/idioma-transporte/<% transporte.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/idiomas_transportes/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
