    ...
    <div ng-controller="alterarIndiceCtrl">
        <div class="box-padrao">
            ...
            <div ng-init="carregaImagem('{{$indice->imagem}}')">
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$indice->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.indice.$dirty">Salvar</button>
                    </div>
