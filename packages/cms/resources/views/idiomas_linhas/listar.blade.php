...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/idiomaLinhaCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="idiomaLinhaCtrl" ng-init="setLinhaId({{$linha_id}})">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-language"></i>&nbsp;Idiomas Linhas</h1>
            ...
            <div ng-show="mostrarForm">
                ...
                @include('cms::idiomas_linhas._form')
                <div class="row">
                ...
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tr ng-repeat="linha in linhas">
                            <td><% linha.id %></td>
                            <td style="display:none;"><img ng-show="linha.imagem" ng-src="imagens/idiomas_linhas/xs-<% linha.imagem %>" width="60"></td>
                            <td><a href="cms/idioma-linha/<% linha.id %>"><% linha.titulo %></a></td>
			    <td><% linha.idioma_sigla %></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/idioma-linha/<% linha.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/idiomas_linhas/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
