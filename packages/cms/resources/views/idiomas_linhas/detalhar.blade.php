...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarIdiomaLinhaCtrl.js') !!}
    <div ng-controller="alterarIdiomaLinhaCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Idioma Linha</h1>
            <?php //print_r($idioma_linha);?>
            <div ng-init="carregaImagem('{{$idioma_linha->imagem}}')">
                <span class="idioma-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($idioma_linha, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$idioma_linha->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.idioma_linha.$dirty">Salvar</button>
                    </div>
