...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/idiomaIndicadorCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="idiomaIndicadorCtrl" ng-init="setIndicadorId({{$indicador_id}})">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-newspaper-o"></i>&nbsp;Idiomas Indicadores</h1>
            ...
            <div ng-show="mostrarForm">
                ...
                @include('cms::idiomas_indicadores._form')
                <div class="row">
                ...
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tr ng-repeat="indicador in indicadores">
                            <td><% indicador.id %></td>
                            <td style="display:none;"><img ng-show="indicador.imagem" ng-src="imagens/idiomas_indicadores/xs-<% indicador.imagem %>" width="60"></td>
                            <td><a href="cms/idioma-indicador/<% indicador.id %>"><% indicador.titulo %></a></td>
			    <td><% indicador.idioma_sigla %></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/idioma-indicador/<% indicador.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/idiomas_indicadores/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
