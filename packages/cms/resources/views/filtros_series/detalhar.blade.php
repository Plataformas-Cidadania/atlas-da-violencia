...
@section('content')
    ...
    <div ng-controller="alterarTextoSerieCtrl">
        <div class="box-padrao">
            <h1><a href="cms/textos_filtro_series"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Filtro Série</h1>
            <div ng-init="carregaImagem('{{$filtro_serie->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($filtro_serie, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$filtro_serie->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.filtro_serie.$dirty">Salvar</button>
                    </div>
