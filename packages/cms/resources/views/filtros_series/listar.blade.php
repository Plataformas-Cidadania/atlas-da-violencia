...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/filtroSerieCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="filtroSerieCtrl" ng-init="setSerieId({{$serie_id}})">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-newspaper-o"></i>&nbsp;Filtros Séries</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Atribuir Filtro</button>
            <button class="btn btn-warning" ng-click="mostrarForm=!mostrarForm" ng-show="mostrarForm">Cancelar</button>
            <br><br>
            <div ng-show="mostrarForm">
                <span class="filtro-obrigatorio" ng-show="form.$invalid">* campos obrigatórios</span><br><br>
                {!! Form::open(['name' =>'form']) !!}
                ...
                @include('cms::filtros_series._form')
                <div class="row">
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="filtror:pointer;">
                                Id
                            ...
                            <th ng-click="ordernarPor('filtro')" style="filtror:pointer;">
                                Titulo
                                <i ng-if="ordem=='filtro' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='filtro' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th></th>
                        </tr>
                        </thead>
                        ...
                        <tr ng-repeat="filtro in filtros">
                            <td><% filtro.id %></td>
                            <td style="display:none;"><img ng-show="filtro.imagem" ng-src="imagens/filtros_filtros/xs-<% filtro.imagem %>" width="60"></td>
                            <td><a href="cms/filtro-filtro/<% filtro.id %>"><% filtro.titulo %></a></td>
                            <td class="text-right">
                                <div>
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(filtro.id, filtro.filtro, filtro.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/filtros_filtros/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
