...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarFonteCtrl.js') !!}
    <div ng-controller="alterarFonteCtrl">
        <div class="box-padrao">
            <h1><a href="cms/fontes"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Fontes</h1>
            <?php //print_r($fonte);?>
            <div ng-init="carregaImagem('{{$fonte->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($fonte, ['name' =>'form']) !!}
                ...
                @include('cms::fonte._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$fonte->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.fonte.$dirty">Salvar</button>
                    </div>
