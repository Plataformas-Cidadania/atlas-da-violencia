...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/fonteCtrl.js') !!}
<script>
    $(function () {
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" ng-model="dadoFonte" placeholder="Faça sua busca"/>
                    </div>
                    <br>
                    <div><% mensagemFonter %></div>
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="fonter:pointer;">
                                Id
                            ...
                            {{--<th>Imagem</th>--}}
                            <th ng-click="ordernarPor('fonte')" style="fonter:pointer;">
                                Fonte
                                <i ng-if="ordem=='fonte' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='fonte' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th></th>
                        </tr>
                        </thead>
