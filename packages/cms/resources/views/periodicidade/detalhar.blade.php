...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarPeriodicidadeCtrl.js') !!}
    <div ng-controller="alterarPeriodicidadeCtrl">
        <div class="box-padrao">
            <h1><a href="cms/periodicidades"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Periodicidades</h1>
            <?php //print_r($periodicidade);?>
            <div ng-init="carregaImagem('{{$periodicidade->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($periodicidade, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$periodicidade->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.periodicidade.$dirty">Salvar</button>
                    </div>
