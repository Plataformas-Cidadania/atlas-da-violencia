...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/periodicidadeCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="periodicidadeCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-newspaper-o"></i>&nbsp;Periodicidades</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Nova Periodicidade</button>
            ...
            <div ng-show="mostrarForm">
                ...
                @include('cms::periodicidade._form')
                <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <br>
                    <div><% mensagemPeriodicidader %></div>
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="periodicidader:pointer;">
                                Id
                            ...
                            {{--<th>Imagem</th>--}}
                            <th ng-click="ordernarPor('periodicidade')" style="periodicidader:pointer;">
                                Periodicidade
                                <i ng-if="ordem=='periodicidade' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='periodicidade' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr ng-repeat="periodicidade in periodicidades">
                            <td><% periodicidade.id %></td>
                            {{--<td><img ng-show="periodicidade.imagem" ng-src="imagens/periodicidades/xs-<% periodicidade.imagem %>" width="60"></td>--}}
                            <td><a href="cms/periodicidade/<% periodicidade.id %>"><% periodicidade.titulo %></a></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/idiomas-periodicidades/<% periodicidade.id %>"><i class="fa fa-language fa-2x" title="Idiomas"></i></a>&nbsp;&nbsp;
                                    {{--<a href="cms/periodicidade/<% periodicidade.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;--}}
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(periodicidade.id, periodicidade.titulo, periodicidade.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/periodicidades/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
