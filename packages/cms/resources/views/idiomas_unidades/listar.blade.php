...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/idiomaUnidadeCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="idiomaUnidadeCtrl" ng-init="setUnidadeId({{$unidade_id}})">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-newspaper-o"></i>&nbsp;Idiomas Unidades</h1>
            ...
            <div ng-show="mostrarForm">
                ...
                @include('cms::idiomas_unidades._form')
                <div class="row">
                ...
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tr ng-repeat="unidade in unidades">
                            <td><% unidade.id %></td>
                            <td style="display:none;"><img ng-show="unidade.imagem" ng-src="imagens/idiomas_unidades/xs-<% unidade.imagem %>" width="60"></td>
                            <td><a href="cms/idioma-unidade/<% unidade.id %>"><% unidade.titulo %></a></td>
			    <td><% unidade.idioma_sigla %></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/idioma-unidade/<% unidade.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/idiomas_unidades/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
