    ...
    <div ng-controller="alterarIdiomaUnidadeCtrl">
        <div class="box-padrao">
            ...
            <div ng-init="carregaImagem('{{$idioma_unidade->imagem}}')">
                ...
                {!! Form::model($idioma_unidade, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$idioma_unidade->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.idioma_unidade.$dirty">Salvar</button>
                    </div>
