...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/textoSerieCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="textoSerieCtrl" ng-init="setSerieId({{$serie_id}})">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-newspaper-o"></i>&nbsp;Idiomas Séries</h1>
                ...
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tr ng-repeat="serie in series">
                            <td><% serie.id %></td>
                            <td style="display:none;"><img ng-show="serie.imagem" ng-src="imagens/textos_series/xs-<% serie.imagem %>" width="60"></td>
                            <td><a href="cms/texto-serie/<% serie.id %>"><% serie.titulo %></a></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/texto-serie/<% serie.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/textos_series/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
