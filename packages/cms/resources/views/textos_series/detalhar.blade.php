...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarTextoSerieCtrl.js') !!}
    <div ng-controller="alterarTextoSerieCtrl">
        <div class="box-padrao">
            <h1><a href="cms/textos_texto_series"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Idioma Série</h1>
            <?php //print_r($texto_serie);?>
            <div ng-init="carregaImagem('{{$texto_serie->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($texto_serie, ['name' =>'form']) !!}
                ...
                @include('cms::textos_series._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$texto_serie->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.texto_serie.$dirty">Salvar</button>
                    </div>
