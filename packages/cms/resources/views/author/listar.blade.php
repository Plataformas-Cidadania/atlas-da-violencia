...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/authorCtrl.js') !!}
<script>
    $(function () {
    ...
    <div ng-controller="authorCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-newspaper-o"></i>&nbsp;Autores</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Novo autor</button>
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" ng-model="dadoAuthor" placeholder="Faça sua busca"/>
                    </div>
                    <br>
                    <div><% mensagemAuthorr %></div>
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="authorr:pointer;">
                                Id
                            ...
                            <th>Imagem</th>
                            <th ng-click="ordernarPor('author')" style="authorr:pointer;">
                                Author
                                <i ng-if="ordem=='author' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='author' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th></th>
                        </tr>
                        </thead>
                        ...
                        <tr ng-repeat="author in authors">
                            <td><% author.id %></td>
                            <td><img ng-show="author.imagem" ng-src="imagens/authors/xs-<% author.imagem %>" width="60"></td>
                            <td><a href="cms/author/<% author.id %>"><% author.titulo %></a></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/author/<% author.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(author.id, author.titulo, author.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="col-md-12">
                ...
                <div ng-show="totalItens > 0" class="clan-paginacao">
                    <div class="item-paginacao">
                        <uib-pagination total-items="totalItens" ng-model="currentPage" max-size="maxSize" class="pagination-sm" boundary-authors="true" force-ellipses="true" items-per-page="itensPerPage" num-pages="numPages"></uib-pagination>
                    </div>
                    <div class="item-paginacao">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/authors/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
