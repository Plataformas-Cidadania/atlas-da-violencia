...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarAuthorCtrl.js') !!}
    <div ng-controller="alterarAuthorCtrl">
        <div class="box-padrao">
            <h1><a href="../authors"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Autor</h1>
            <?php //print_r($author);?>
            <div ng-init="carregaImagem('{{$author->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($author, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$author->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.author.$dirty">Salvar</button>
                    </div>
