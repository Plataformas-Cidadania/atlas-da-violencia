...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarTransporteCtrl.js') !!}
    <div ng-controller="alterarTransporteCtrl">
        <div class="box-padrao">
            <h1><a href="cms/transportes"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Transportes</h1>
            <?php //print_r($transporte);?>
            <div ng-init="carregaImagem('{{$transporte->imagem}}', '{{$transporte->icone}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($transporte, ['name' =>'form']) !!}
                <div class="row">
                    <div class="col-md-2">
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$transporte->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile, picFileIcone)" ng-disabled="form.$invalid && form.transporte.$dirty">Salvar</button>
                    </div>
