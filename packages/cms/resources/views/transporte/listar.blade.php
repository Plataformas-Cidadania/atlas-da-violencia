...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/transporteCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="transporteCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-newspaper-o"></i>&nbsp;Transportes</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Novo Transporte</button>
            ...
            <div ng-show="mostrarForm">
                    ...
                    <div class="col-md-2">
                        <div class="container-thumb">
                            <div class="box-thumb" name="fileDrop" ngf-drag-over-class="'box-thumb-hover'" ngf-drop ngf-select ng-model="picFileIcone"
                                 ng-show="!picFileIcone" accept="image/*" ngf-max-size="2MB">Solte uma icone aqui!</div>
                            <img  ngf-thumbnail="picFileIcone" class="thumb">
                        </div>
                        <br>
                        <span class="btn btn-primary btn-file" ng-show="!picFileIcone">
                        Escolher icone <input  type="file" ngf-select ng-model="picFileIcone" name="fileIcone" accept="image/*" ngf-max-size="2MB" ngf-model-invalid="errorFileIcone">
                    </span>
                        <button class="btn btn-danger" ng-click="picFileIcone = null" ng-show="picFileIcone" type="button">Remover Icone</button>
                        <i ng-show="form.file.$error.maxSize || form.fileDrop.$error.maxSize" style="margin-left: 10px;">
                            Arquivo muito grande <% errorFile.size / 1000000|number:1 %>MB: máximo 2MB
                            <div class="btn btn-danger" ng-click="limparIcone()">Cancelar</div>
                        </i>
                    <br><br>
                    </div>
                </div>
                ...
                @include('cms::transporte._form')
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="inserir(picFile, picFileIcone)" ng-disabled="form.$invalid">Salvar</button>
                    </div>
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="transporter:pointer;">
                                Id
                            ...
                            {{--<th>Imagem</th>--}}
                            <th ng-click="ordernarPor('transporte')" style="transporter:pointer;">
                                Transporte
                                <i ng-if="ordem=='transporte' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='transporte' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr ng-repeat="transporte in transportes">
                            <td><% transporte.id %></td>
                            {{--<td><img ng-show="transporte.imagem" ng-src="imagens/transportes/xs-<% transporte.imagem %>" width="60"></td>--}}
                            <td><a href="cms/transporte/<% transporte.id %>"><% transporte.titulo %></a></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/linhas/<% transporte.id %>"><i class="fa fa-plus fa-2x" title="Linhas"></i></a>&nbsp;&nbsp;
                                    <a href="cms/idiomas-transportes/<% transporte.id %>"><i class="fa fa-language fa-2x" title="Idiomas"></i></a>&nbsp;&nbsp;
                                    <a href="cms/transporte/<% transporte.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(transporte.id, transporte.titulo, transporte.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/transportes/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
