...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/textCtrl.js') !!}
<script>
    $(function () {
    ...
    <div ng-controller="textCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-desktop"></i>&nbsp;Texts</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Novo Texto</button>
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" ng-model="dadoText" placeholder="Faça sua busca"/>
                    </div>
                    <br>
                    <div><% mensagemTextr %></div>
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="textr:pointer;">
                                Id
                            ...
                            <th>Imagem</th>
                            <th ng-click="ordernarPor('text')" style="textr:pointer;">
                                Text
                                <i ng-if="ordem=='text' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='text' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th></th>
                        </tr>
                        </thead>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="/imagens/texts/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
