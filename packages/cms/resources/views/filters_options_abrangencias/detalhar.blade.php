...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarFilterOptionAbrangenciaCtrl.js') !!}
    <div ng-controller="alterarFilterOptionAbrangenciaCtrl">
        <div class="box-padrao">
            <h1><a href="javascript: history.go(-1);"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Filter Option Abrangencia</h1>
            <?php //print_r($filter_optionAbrangencia);?>
            <div ng-init="carregaImagem('{{$filter_optionAbrangencia->imagem}}')">
                <span class="filter-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($filter_optionAbrangencia, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$filter_optionAbrangencia->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.filter_optionAbrangencia.$dirty">Salvar</button>
                    </div>
