...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarMenuCtrl.js') !!}
    <div ng-controller="alterarMenuCtrl">
        <div class="box-padrao">
            <h1><a href="cms/menus"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Menus</h1>
            <?php //print_r($menu);?>
            <div ng-init="carregaImagem('{{$menu->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($menu, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$menu->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.menu.$dirty">Salvar</button>
                    </div>
