...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/videoCtrl.js') !!}
<script>
    $(function () {
    ...
    <div ng-controller="videoCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-newspaper-o"></i>&nbsp;Videos</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Novo Video</button>
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" ng-model="dadoVideo" placeholder="Faça sua busca"/>
                    </div>
                    <br>
                    <div><% mensagemVideor %></div>
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="videor:pointer;">
                                Id
                            ...
                            <th ng-click="ordernarPor('video')" style="videor:pointer;">
                                ...
                                <i ng-if="ordem=='video' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th></th>
                        </tr>
                        </thead>
