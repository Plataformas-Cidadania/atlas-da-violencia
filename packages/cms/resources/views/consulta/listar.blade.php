...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/consultaCtrl.js') !!}
<script>
    $(function () {
    ...
    <div ng-controller="consultaCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-newspaper-o"></i>&nbsp;Consultas</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Novo consulta</button>
            <button class="btn btn-warning" ng-click="mostrarForm=!mostrarForm" ng-show="mostrarForm">Cancelar</button>

            <a href="cms/quemsomos/5/consultas"  class="btn btn-success"  ng-show="!mostrarForm">Descrição</a>
            <br><br>
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="consultar:pointer;">
                                Id
                            ...
                            {{--<th>Imagem</th>--}}
                            <th ng-click="ordernarPor('idiomas_consultas.titulo')" style="consultar:pointer;">
                                Consulta
                                <i ng-if="ordem=='idiomas_consultas.titulo' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='idiomas_consultas.titulo' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th ng-click="ordernarPor('idiomas_consultas.idioma_sigla')" style="consultar:pointer;">
                                Idioma
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/consultas/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
