...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarConsultaCtrl.js') !!}
    <div ng-controller="alterarConsultaCtrl">
        <div class="box-padrao">
            <h1><a href="cms/consultas"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Consultas</h1>
            <?php //print_r($consulta);?>
            <div ng-init="carregaImagem('{{$consulta->imagem}}', '{{$consulta->arquivo}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($consulta, ['name' =>'form']) !!}
                ...
                <a href="arquivos/consultas/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                <a ng-show="fileArquivo"><% fileArquivo.name %></a>
                <br><br>

                @include('cms::consulta._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$consulta->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile, fileArquivo)" ng-disabled="form.$invalid && form.consulta.$dirty">Salvar</button>
                    </div>
