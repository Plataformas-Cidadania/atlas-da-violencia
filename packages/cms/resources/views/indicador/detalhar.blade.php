...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarIndicadorCtrl.js') !!}
    <div ng-controller="alterarIndicadorCtrl">
        <div class="box-padrao">
            <h1><a href="cms/indicadores"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Indicadores</h1>
            <?php //print_r($indicador);?>
            <div ng-init="carregaImagem('{{$indicador->imagem}}')">
                ...
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.indicador.$dirty">Salvar</button>
                    </div>
