...
{!! Form::select('idioma_sigla',
        $idiomas,
null, ['class'=>"form-control width-medio <% validar(webdoor.idioma_sigla) %>", 'ng-model'=>'webdoor.idioma_sigla', 'ng-required'=>'true', 'init-model'=>'webdoor.idioma_sigla', 'placeholder' => 'Selecione']) !!}<br>
