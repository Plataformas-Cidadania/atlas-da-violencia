...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/idiomaOptionAbrangenciaCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="idiomaOptionAbrangenciaCtrl" ng-init="setOptionAbrangenciaId({{$option_abrangencia_id}})">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-language"></i>&nbsp;Idiomas Options Abrangencias</h1>
            ...
            <div ng-show="mostrarForm">
                ...
                @include('cms::idiomas_options_abrangencias._form')
                <div class="row">
                ...
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tr ng-repeat="optionAbrangencia in optionsAbrangencias">
                            ...
                            <td style="display:none;"><img ng-show="optionAbrangencia.imagem" ng-src="imagens/idiomas_options_abrangencias/xs-<% optionAbrangencia.imagem %>" width="60"></td>
                            <td><a href="cms/idioma-optionAbrangencia/<% optionAbrangencia.id %>"><% optionAbrangencia.title %></a></td>
			    <td><% optionAbrangencia.idioma_sigla %></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/idioma-option-abrangencia/<% optionAbrangencia.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/idiomas_options_abrangencias/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
