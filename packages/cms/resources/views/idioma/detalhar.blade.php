...
@section('content')
    ...
    <div ng-controller="alterarIdiomaCtrl">
        <div class="box-padrao">
            ...
            <?php //print_r($idioma);?>
            <div ng-init="carregaImagem('{{$idioma->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($idioma, ['name' =>'form']) !!}
                <div>
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$idioma->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.idioma.$dirty">Salvar</button>
                    </div>
