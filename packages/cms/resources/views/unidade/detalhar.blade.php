...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarUnidadeCtrl.js') !!}
    <div ng-controller="alterarUnidadeCtrl">
        <div class="box-padrao">
            <h1><a href="cms/unidades"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Unidades</h1>
            <?php //print_r($unidade);?>
            <div ng-init="carregaImagem('{{$unidade->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($unidade, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$unidade->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.unidade.$dirty">Salvar</button>
                    </div>
