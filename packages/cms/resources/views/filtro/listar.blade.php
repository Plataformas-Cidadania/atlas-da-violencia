...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/filtroCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="filtroCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-newspaper-o"></i>&nbsp;Filtros</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Novo Filtro</button>
                ...
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tr ng-repeat="filtro in filtros">
                            <td><% filtro.id %></td>
                            {{--<td><img ng-show="filtro.imagem" ng-src="imagens/filtros/xs-<% filtro.imagem %>" width="60"></td>--}}
                            <td><a href="cms/filtro/<% filtro.id %>"><% filtro.titulo %></a></td>
                            <td class="text-right">
                                <div>

                                    <a href="cms/filtro/<% filtro.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(filtro.id, filtro.titulo, filtro.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/filtros/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
