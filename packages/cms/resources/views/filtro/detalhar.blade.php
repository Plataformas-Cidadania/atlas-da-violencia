...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarFiltroCtrl.js') !!}
    <div ng-controller="alterarFiltroCtrl">
        <div class="box-padrao">
            <h1><a href="cms/filtros"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Filtros</h1>
            <?php //print_r($filtro);?>
            <div ng-init="carregaImagem('{{$filtro->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($filtro, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$filtro->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.filtro.$dirty">Salvar</button>
                    </div>
