...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarIdiomaRadarCtrl.js') !!}
    <div ng-controller="alterarIdiomaRadarCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Idioma Radar</h1>
            <?php //print_r($idioma_radar);?>
            <div ng-init="carregaImagem('{{$idioma_radar->imagem}}')">
                <span class="idioma-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($idioma_radar, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$idioma_radar->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.idioma_radar.$dirty">Salvar</button>
                    </div>
