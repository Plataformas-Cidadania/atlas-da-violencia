...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/idiomaRadarCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="idiomaRadarCtrl" ng-init="setRadarId({{$radar_id}})">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-language"></i>&nbsp;Idiomas Radares</h1>
            ...
            <div ng-show="mostrarForm">
                ...
                @include('cms::idiomas_radares._form')
                <div class="row">
                ...
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tr ng-repeat="radar in radares">
                            <td><% radar.id %></td>
                            <td style="display:none;"><img ng-show="radar.imagem" ng-src="imagens/idiomas_radares/xs-<% radar.imagem %>" width="60"></td>
                            <td><a href="cms/idioma-radar/<% radar.id %>"><% radar.titulo %></a></td>
			    <td><% radar.idioma_sigla %></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/idioma-radar/<% radar.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/idiomas_radares/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
