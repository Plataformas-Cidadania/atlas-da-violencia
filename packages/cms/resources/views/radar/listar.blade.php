...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/radarCtrl.js') !!}
<script>
    $(function () {
    ...
    <div ng-controller="radarCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-newspaper-o"></i>&nbsp;Radares</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Novo Radar</button>
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="radarr:pointer;">
                                Id
                            ...
                            {{--<th>Imagem</th>--}}
                            <th ng-click="ordernarPor('radar')" style="radarr:pointer;">
                                Radar
                                <i ng-if="ordem=='radar' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='radar' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr ng-repeat="radar in radares">
                            <td><% radar.id %></td>
                            {{--<td><img ng-show="radar.imagem" ng-src="imagens/radares/xs-<% radar.imagem %>" width="60"></td>--}}
                            <td><a href="cms/radar/<% radar.id %>"><% radar.titulo %></a></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/linhas/<% radar.id %>"><i class="fa fa-plus fa-2x" title="Linhas"></i></a>&nbsp;&nbsp;
                                    <a href="cms/idiomas-radares/<% radar.id %>"><i class="fa fa-language fa-2x" title="Idiomas"></i></a>&nbsp;&nbsp;
                                    <a href="cms/radar/<% radar.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(radar.id, radar.titulo, radar.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/radares/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
