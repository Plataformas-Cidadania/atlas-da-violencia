...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarRadarCtrl.js') !!}
    <div ng-controller="alterarRadarCtrl">
        <div class="box-padrao">
            <h1><a href="cms/radares"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Radares</h1>
            <?php //print_r($radar);?>
            <div ng-init="carregaImagem('{{$radar->imagem}}', '{{$radar->icone}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($radar, ['name' =>'form']) !!}
                <div class="row">
                    <div class="col-md-2">
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$radar->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile, picFileIcone)" ng-disabled="form.$invalid && form.radar.$dirty">Salvar</button>
                    </div>
