...
@section('content')
    {!! Html::script('assets-cms/js/controllers/printingCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="printingCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-printing" aria-hidden="true"></i>&nbsp;Printings</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Nova Printing</button>
            ...
            <div ng-show="mostrarForm">
                ...
                <span class="btn btn-primary btn-file" ng-show="!fileArquivo">
                    Escolher Arquivo <input  type="file" ngf-select ng-model="fileArquivo" name="fileArquivo" accept="application/pdf,.zip,.rar,.doc,.docx,.xlsx,.xls, .ai, .eps" ngf-max-size="100MB" ngf-model-invalid="errorFile">
                </span>
                <a ng-show="fileArquivo"><% fileArquivo.name %></a>


                <br><br>
                @include('cms::printing._form')
                <div class="row">
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" ng-model="dadoPrinting" placeholder="Faça sua busca"/>
                    </div>
                    <br>
                    <div><% mensagemPrintingr %></div>
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="printingr:pointer;">
                                Id
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/printings/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% titleExcluir %></p>
                            </div>
