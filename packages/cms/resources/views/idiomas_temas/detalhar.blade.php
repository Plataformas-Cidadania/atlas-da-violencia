    ...
    <div ng-controller="alterarIdiomaTemaCtrl">
        <div class="box-padrao">
            ...
            <div ng-init="carregaImagem('{{$idioma_tema->imagem}}')">
                ...
                {!! Form::model($idioma_tema, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$idioma_tema->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.idioma_tema.$dirty">Salvar</button>
                    </div>
