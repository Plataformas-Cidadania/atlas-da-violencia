...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarPadraoTerritorioCtrl.js') !!}
    <div ng-controller="alterarPadraoTerritorioCtrl">
        <div class="box-padrao">
            <h1><a href="cms/padrao-territorios"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Padrao Territorios</h1>
            <?php //print_r($padraoTerritorio);?>
            <div ng-init="carregaImagem('{{$padraoTerritorio->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($padraoTerritorio, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$padraoTerritorio->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.padraoTerritorio.$dirty">Salvar</button>
                    </div>
