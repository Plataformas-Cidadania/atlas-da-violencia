...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/idiomaApiCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="idiomaApiCtrl" ng-init="setApiId({{$api_id}})">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-language"></i>&nbsp;Idiomas Apis</h1>
            ...
            <div ng-show="mostrarForm">
                ...
                @include('cms::idiomas_apis._form')
                <div class="row">
                ...
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tr ng-repeat="api in apis">
                            <td><% api.id %></td>
                            <td style="display:none;"><img ng-show="api.imagem" ng-src="imagens/idiomas_apis/xs-<% api.imagem %>" width="60"></td>
                            <td><a href="cms/idioma-api/<% api.id %>"><% api.titulo %></a></td>
			    <td><% api.idioma_sigla %></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/idioma-api/<% api.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/idiomas_apis/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
