...
@section('content')
    ...
    <div ng-controller="alterarArtigoCtrl">
        <div class="box-padrao">
            <h1><a href="cms/artigos"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Artigos</h1>
            <?php //print_r($artigo);?>
            <div ng-init="carregaImagem('{{$artigo->imagem}}', '{{$artigo->arquivo}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($artigo, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$artigo->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile, fileArquivo)" ng-disabled="form.$invalid && form.artigo.$dirty">Salvar</button>
                    </div>
