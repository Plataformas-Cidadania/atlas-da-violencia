...
@section('content')
    ...
    <div ng-controller="alterarArtigoCtrl">
        <div class="box-padrao">
            ...
            <?php //print_r($artigo);?>
            <div ng-init="carregaImagem('{{$artigo->imagem}}')">
                ...
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.artigo.$dirty">Salvar</button>
                    </div>
