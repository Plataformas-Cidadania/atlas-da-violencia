...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/artigoCtrl.js') !!}
<script>
    $(function () {
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="artigor:pointer;">
                                Id
                            ...
                            <th>Imagem</th>
                            <th ng-click="ordernarPor('artigo')" style="artigor:pointer;">
                                Artigo
                                <i ng-if="ordem=='artigo' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='artigo' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th ng-click="ordernarPor('idioma_sigla')" style="artigor:pointer;">
                                Idioma
                        ...
                        <tbody>
                        <tr ng-repeat="artigo in artigos">
                            <td><% artigo.id %></td>
                            <td><img ng-show="artigo.imagem" ng-src="imagens/artigos/xs-<% artigo.imagem %>" width="60"></td>
                            <td><a href="cms/artigo/<% artigo.id %>"><% artigo.titulo %></a></td>
                            <td><a href="cms/artigo/<% artigo.id %>"><% artigo.idioma_sigla %></a></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/artigo/<% artigo.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(artigo.id, artigo.titulo, artigo.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/artigos/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
