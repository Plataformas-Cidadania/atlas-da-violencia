...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/idiomaPeriodicidadeCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="idiomaPeriodicidadeCtrl" ng-init="setPeriodicidadeId({{$periodicidade_id}})">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-language"></i>&nbsp;Idiomas Periodicidades</h1>
            ...
            <div ng-show="mostrarForm">
                ...
                @include('cms::idiomas_periodicidades._form')
                <div class="row">
                ...
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tr ng-repeat="periodicidade in periodicidades">
                            ...
                            <td style="display:none;"><img ng-show="periodicidade.imagem" ng-src="imagens/idiomas_periodicidades/xs-<% periodicidade.imagem %>" width="60"></td>
                            <td><a href="cms/idioma-periodicidade/<% periodicidade.id %>"><% periodicidade.titulo %></a></td>
			    <td><% periodicidade.idioma_sigla %></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/idioma-periodicidade/<% periodicidade.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/idiomas_periodicidades/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
