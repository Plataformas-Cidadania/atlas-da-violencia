...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarIdiomaAssuntoCtrl.js') !!}
    <div ng-controller="alterarIdiomaAssuntoCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Idioma Assunto</h1>
            <?php //print_r($idioma_assunto);?>
            <div ng-init="carregaImagem('{{$idioma_assunto->imagem}}')">
                <span class="idioma-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($idioma_assunto, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$idioma_assunto->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.idioma_assunto.$dirty">Salvar</button>
                    </div>
