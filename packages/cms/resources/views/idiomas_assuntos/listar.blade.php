...
@section('content')
    {!! Html::script('/assets-cms/js/controllers/idiomaAssuntoCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="idiomaAssuntoCtrl" ng-init="setAssuntoId({{$assunto_id}})">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-language"></i>&nbsp;Idiomas Assuntos</h1>
            ...
            <div ng-show="mostrarForm">
                ...
                @include('cms::idiomas_assuntos._form')
                <div class="row">
                ...
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th ng-click="ordernarPor('assunto')" style="assuntor:pointer;">
                                Titulo
                        ...
                        <tr ng-repeat="assunto in assuntos">
                            <td><% assunto.id %></td>
                            <td style="display:none;"><img ng-show="assunto.imagem" ng-src="imagens/idiomas_assuntos/xs-<% assunto.imagem %>" width="60"></td>
                            <td><a href="cms/idioma-assunto/<% assunto.id %>"><% assunto.titulo %></a></td>
			    <td><% assunto.idioma_sigla %></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/idioma-assunto/<% assunto.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(assunto.id, assunto.titulo, assunto.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/idiomas_assuntos/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
