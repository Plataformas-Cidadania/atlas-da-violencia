...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarDownloadCtrl.js') !!}
    <div ng-controller="alterarDownloadCtrl">
        <div class="box-padrao">
            <h1><a href="../downloads"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Downloads</h1>
            <?php //print_r($download);?>
            <div ng-init="carregaImagem('{{$download->imagem}}', '{{$download->arquivo}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($download, ['name' =>'form']) !!}
                ...
                <br><br>
                @include('cms::download._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$download->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile, fileArquivo)" ng-disabled="form.$invalid && form.download.$dirty">Salvar</button>
                    </div>
