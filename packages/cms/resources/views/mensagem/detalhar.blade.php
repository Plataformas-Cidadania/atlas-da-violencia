...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarMensagemCtrl.js') !!}
    <div ng-controller="alterarMensagemCtrl">
        <div class="box-padrao">
            <h1><a href="javascript: history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Mensagem</h1>
            <?php //print_r($mensagem);?>

            <div style="display: none;">
                <div ng-init="carregaImagem('{{$mensagem->imagem}}')">
                    <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                    {!! Form::model($mensagem, ['name' =>'form']) !!}
                ...
                @include('cms::mensagem._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$mensagem->id}}'"/>
                <div class="row" style="display: none;">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.mensagem.$dirty">Salvar</button>
                    </div>
