    ...
    <div ng-controller="temaSerieCtrl" ng-init="setSerieId({{$serie_id}})">
        <div class="box-padrao">
            ...
            <div ng-show="mostrarForm">
                <span class="tema-obrigatorio" ng-show="form.$invalid">* campos obrigatórios</span><br><br>
                {!! Form::open(['name' =>'form']) !!}
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th ng-click="ordernarPor('tema')" style="temar:pointer;">
                                Titulo
                                <i ng-if="ordem=='tema' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='tema' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th></th>
                        </tr>
                        </thead>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/temas_temas/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
