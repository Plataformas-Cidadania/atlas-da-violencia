...
class IdiomaOptionAbrangenciaController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->pathImagem = public_path().'/imagens/idiomas-options-abrangencias';
        $this->sizesImagem = [
    ...
    function index($option_abrangencia_id)
    {
        ...
        return view('cms::idiomas_options_abrangencias.listar', ['option_abrangencia_id' => $optionAbrangencia->id, 'idiomas' => $idiomas]);
    }
    ...
    public function listar(Request $request)
    {
        ...
        $optionsAbrangencias = DB::table('idiomas_options_abrangencias')
            ->select($campos)
            ->where([
    ...
    public function inserir(Request $request)
    {
        ...
        if($file!=null){
            ...
            if($success){
                ...
                return $this->idiomaOptionAbrangencia->create($data['optionAbrangencia']);
            }else{
                return "erro";
            }
        }

        $optionAbrangencia = $this->idiomaOptionAbrangencia->create($data['optionAbrangencia']);
    ...
    {
        $idioma_optionAbrangencia = $this->idiomaOptionAbrangencia
            ->where([
            ['id', '=', $id],
        ])->first();
        $idiomas = \App\Idioma::lists('titulo', 'sigla')->all();

        $option_abrangencia_id = $idioma_optionAbrangencia->option_abrangencia_id;

        return view('cms::idiomas_options_abrangencias.detalhar', [
            'idioma_optionAbrangencia' => $idioma_optionAbrangencia,
            'idiomas' => $idiomas,
    ...
    public function alterar(Request $request, $id)
    {
        ...
        $optionAbrangencia = $this->idiomaOptionAbrangencia->where([
            ['id', '=', $id],
        ])->firstOrFail();
