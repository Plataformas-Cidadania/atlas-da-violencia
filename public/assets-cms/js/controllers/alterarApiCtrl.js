cmsApp.controller('alterarApiCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.alterar = function (file){
        ...
        if(file==null){
            ...
            $http.post("cms/alterar-api/"+$scope.id, {'api': $scope.api, 'removerImagem': $scope.removerImagem}).success(function (data){
                //console.log(data);
                $scope.processandoSalvar = false;
            ...
            file.upload.then(function (response) {
                ...
                $scope.removerImagem = false;
                $scope.imagemBD = '/imagens/apis/'+response.data;
