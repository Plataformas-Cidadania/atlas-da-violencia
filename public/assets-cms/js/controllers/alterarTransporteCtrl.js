cmsApp.controller('alterarTransporteCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.alterar = function (file, fileIcone){
        ...
        if(file==null && fileIcone==null){
            ...
            $http.post("cms/alterar-transporte/"+$scope.id, {
            ...
            Upload.upload({
                url: 'cms/alterar-transporte/'+$scope.id,
                data: data1
                ...
                $scope.removerImagem = false;
                $scope.imagemBD = '/imagens/transporte/'+response.data;
                $scope.processandoSalvar = false;
    ...
    $scope.carregaImagem  = function(img, icone) {
        ...
        if(icone!=''){
            $scope.iconeBD = 'imagens/transportes_icones/xs-'+icone;
