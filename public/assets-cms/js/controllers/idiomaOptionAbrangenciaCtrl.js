cmsApp.controller('idiomaOptionAbrangenciaCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.dadoPesquisa = '';
    $scope.campos = "id, title, idioma_sigla";
    ...
    var listarOptionsAbrangencias = function(){
        ...
        $http({
            url: 'cms/listar-idiomas-options-abrangencias',
            method: 'GET',
            params: {
    ...
    $scope.inserir = function (file){
        ...
        if(file==null){
            ...
            $http.post("cms/inserir-idioma-option-abrangencia", {optionAbrangencia: $scope.optionAbrangencia, idiomas: $scope.idiomas}).success(function (data){
                 listarOptionsAbrangencias();
            ...
            file.upload = Upload.upload({
                url: 'cms/inserir-idioma-option-abrangencia',
                data: {optionAbrangencia: $scope.optionAbrangencia, idiomas: $scope.idiomas, file: file},
            });
    ...
    $scope.excluir = function(id){
        ...
        $http({
            url: 'cms/excluir-idioma-option-abrangencia/'+id,
            method: 'GET'
        }).success(function(data, status, headers, config){
            console.log(data);
            $scope.processandoExcluir = false;
