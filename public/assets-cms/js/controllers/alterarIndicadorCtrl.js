cmsApp.controller('alterarIndicadorCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.alterar = function (file){
        ...
        if(file==null){
            ...
            $http.post("cms/alterar-indicador/"+$scope.id, {'indicador': $scope.indicador, 'removerImagem': $scope.removerImagem}).success(function (data){
                //console.log(data);
                $scope.processandoSalvar = false;
            ...
            file.upload = Upload.upload({
                url: 'cms/alterar-indicador/'+$scope.id,
            ...
            file.upload.then(function (response) {
                ...
                $scope.removerImagem = false;
                $scope.imagemBD = '/imagens/indicadores/'+response.data;
