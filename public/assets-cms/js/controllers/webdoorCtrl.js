cmsApp.controller('webdoorCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.$watch('dadoWebdoor', function(){
        if($listar){
            listarWebdoors();
        }
    });
    ...
    /*$scope.loadMore = function() {
     $scope.currentPage +=1;
     $http({
     url: '/api/webdoors/'+$scope.itensPerPage,
     method: 'GET',
     ...
     //$scope.webdoors = $scope.webdoors.concat(data.data);
