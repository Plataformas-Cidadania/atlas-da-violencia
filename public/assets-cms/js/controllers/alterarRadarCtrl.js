cmsApp.controller('alterarRadarCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.alterar = function (file, fileIcone){
        ...
        if(file==null && fileIcone==null){
            ...
            $http.post("cms/alterar-radar/"+$scope.id, {
                'radar': $scope.radar,
            ...
            Upload.upload({
                url: 'cms/alterar-radar/'+$scope.id,
                data: data1
                ...
                $scope.removerImagem = false;
                $scope.imagemBD = '/imagens/radar/'+response.data;
                $scope.processandoSalvar = false;
    ...
    $scope.carregaImagem  = function(img, icone) {
        ...
        if(icone!=''){
            $scope.iconeBD = 'imagens/radares_icones/xs-'+icone;
