    ...
    render() {
        ...
        let categories = this.state.categories.map(function (item) {
            ...
            return React.createElement(
                'div',
                { key: 'cat_' + item.id, style: { cursor: 'pointer', color: color }, onClick: () => this.addCategory(item) },
                React.createElement(
                    'u',
                    null,
                    firstPiece
        ...
        return React.createElement(
            ...
            React.createElement(
                'div',
                { className: 'div-info', style: { border: "solid 1px #CCC", display: this.state.showCategories ? 'block' : 'none' } },
                categories
            )
        );
    }
