class Type extends React.Component {
    ...
    render() {
        ...
        return React.createElement(
            'div',
            null,
            React.createElement('input', { type: 'text', name: 'titleType', className: 'form-control input-sm', onClick: this.clickSearch, onChange: this.handleSearch, placeholder: 'Pesquise pelo tipo de locomo\xE7\xE3o' }),
            React.createElement(
                'div',
