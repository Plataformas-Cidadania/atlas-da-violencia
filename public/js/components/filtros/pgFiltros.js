class PgFiltros extends React.Component {
    ...
    serieMarked(id, typeRegionSerie, tipoValores, periodicidade) {
        console.log('serieMarked', id, typeRegionSerie, tipoValores, periodicidade);
        this.setState({ serieMarked: id, typeRegionSerie: typeRegionSerie, tipoValores: tipoValores, periodicidade: periodicidade });
    }
