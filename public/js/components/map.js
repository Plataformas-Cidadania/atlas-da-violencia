    ...
    makeInfo() {
        this.setState({ info: L.control() }, function () {
            ...
            this.state.info.update = function (props) {
                ...
                this._div.innerHTML = '<h6 style="margin: 3px 0; font-weight: bold">' + _this.state.serie + '</h6>' + (props ? '<b>' + sigla + props.nome + '</b><br />' + formatNumber(props.total, _this.props.decimais, ',', '.') : 'Passe o mouse na região');
            };
